package com.antik.wallet.feature.museum.list
...
import com.antik.wallet.feature.museum.list.SideEffect
import com.antik.wallet.uikit.UiKitEmptyState
...
fun ListScreen(
    ...
    AnimatedContent(state.objects.isNotEmpty() || state.isLoading) { hasContent ->
        if (hasContent && state.objects.isNotEmpty()) {
            ...
            UiKitEmptyState(
                title = context.getString(com.antik.wallet.R.string.no_data_available),
